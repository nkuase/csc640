...
# Drop and recreate database completely to ensure clean state
...
# Test Bearer Token API endpoints:""
...
echo ""
echo "To test Bearer Token API endpoints:"
echo "   Generate token: ./generate-token.sh"
echo "   Test APIs:"
echo "     curl -H \"Authorization: Bearer \$(cat api_token.txt)\" http://localhost:8000/api/goodbye"